  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (departamentos.length == 0) {
        ...
        var html =
          "<p style='font-family: cuerpo; font-weight: 900'>Departamento</p><ul style='list-style: none;'>";
        for (var i = 0; i < departamentos.length; i++) {
          html +=
            "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' categoria='1' tipo='seleccionable' style='padding: 15px;background: #006B86;cursor: pointer' seleccionado='0'  name='dep" +
            departamentos[i][0] +
            "' id='dep" +
            departamentos[i][0] +
            "'>" +
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (departamentos.length == 0) {
        ...
        var html =
          "<p style='font-family: cuerpo; font-weight: 900'>Nivel 1</p><ul style='list-style: none;'>";
        for (var i = 0; i < departamentos.length; i++) {
          html +=
            "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' tipo='seleccionable' style='padding: 15px;background: #006B86;cursor: pointer' seleccionado='0' categoria='2' id='fam" +
            departamentos[i][0] +
            "'>" +
            departamentos[i][1] +
            "</li>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (departamentos.length == 0) {
        ...
        var html =
          "<p style='font-family: cuerpo; font-weight: 900'>Nivel 2</p><ul style='list-style: none;'>";
        for (var i = 0; i < departamentos.length; i++) {
          html +=
            "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' tipo='seleccionable' style='padding: 15px;background: #006B86;cursor: pointer' seleccionado='0' categoria='3' id='subfam" +
            departamentos[i][0] +
            "'>" +
            departamentos[i][1] +
            "</li>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (departamentos.length == 0) {
        ...
        var html =
          "<p style='font-family: cuerpo; font-weight: 900'>Nivel 3</p><ul style='list-style: none;'>";
        for (var i = 0; i < departamentos.length; i++) {
          html +=
            "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' tipo='seleccionable' style='padding: 15px;background: #006B86;cursor: pointer' seleccionado='0' categoria='4' id='subfam1" +
            departamentos[i][0] +
            "'>" +
            departamentos[i][1] +
            "</li>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (departamentos.length == 0) {
        ...
        var html =
          "<p style='font-family: cuerpo; font-weight: 900'>Nivel 4</p><ul style='list-style: none;'>";
        for (var i = 0; i < departamentos.length; i++) {
          html +=
            "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' tipo='seleccionable' style='padding: 15px;background: #006B86;cursor: pointer' seleccionado='0' categoria='5' id='subfam2" +
            departamentos[i][0] +
            "'>" +
            departamentos[i][1] +
            "</li>";
...
function previsualizacion() {
  if (idDepartamento != "") {
    ...
    html = tempHtml;
    html +=
      " <span style='color: red; font-size: 24px;cursor: pointer' onclick='borrarFila(" +
      fila +
      ")'><img height='25px;' style='position:relative; top: 6px;' src='media/img/equis.png'/></span><hr style='border: 1px solid white;'>";
    html += "</div>";
    ...
    $.ajax({
      ...
      success: function (response) {
        try {
          ...
          $("#contenedorGrafico1").html(
            "<canvas id='visionGeneral' style='width:100;'></canvas>"
          );
        ...
        var total_horas_empleado =
          response[response.length - 1][1] * response[response.length - 1][2];
        ...
        var html =
          "Horas totales: <span style='font-weight:900; font-size: 20px'>";
        html += total_horas;
        html += "</span> Dias: ";
        ...
        html += "<br/>";
        html +=
          "Horas por empleado: <span style='font-weight:900; font-size: 20px'>";
        html += total_horas_empleado;
        html += "</span>";
        html += "<br/>";
        html +=
          "Numero empleados: <span style='font-weight:900; font-size: 20px'>";
        html += empleados;
        html += "</span>";
    ...
    $.ajax({
      ...
      success: function (response) {
        try {
          ...
          $("#contenedorGrafico2").html(
            "<canvas id='visionPorEmpleado' style='width:100;'></canvas>"
          );
            ...
            tooltips: {
              callbacks: {
                ...
                label: function (tooltipItem, data) {
                  ...
                  var valor =
                    (value /
                      (response.datos.dias * response.datos.horas_jornada)) *
                    100;
                  return [valor.toFixed(2) + "%  " + value + " hrs"];
                },
              },
...
function cargarEmpleados() {
  $.ajax({
    ...
    success: function (response) {
      var html =
        "<p style='font-family: cuerpo; font-weight: 900'>Empleados</p><ul style='list-style: none;'>";
      for (var i = 0; i < response.length; i++) {
        html +=
          "<li onmouseenter='$(this).css(\"background-color\", colorHover);' onmouseleave='$(this).css(\"background-color\", colorNormal);' tipo='empleado' style='padding: 15px;background: #006B86;cursor: pointer' seleccionad='0' categoria='e' idempleado='" +
          response[i][0] +
          "' id='emp" +
          response[i][0] +
          "'>" +
